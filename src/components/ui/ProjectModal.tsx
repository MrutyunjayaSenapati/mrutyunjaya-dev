    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
        ...
        <motion.div
          ...
          className="relative w-full max-w-2xl bg-surface border border-border rounded-3xl p-6 sm:p-8 shadow-2xl z-10 max-h-[85vh] overflow-y-auto text-left"
        >
          {/* Close Button */}
          <button
            onClick={onClose}
          ...
          {project.portals && project.portals.length > 0 && (
            <div className="mt-6 p-4 rounded-2xl bg-surface-elevated border border-amber-500/30 space-y-2">
              <h3 className="text-xs font-semibold text-amber-400 uppercase tracking-wider">
                Multi-Portal Architecture (4 Applications)
              </h3>
          ...
          <div className="mt-6 p-4 rounded-2xl bg-slate-950 border border-border space-y-2">
            ...
            <div className="p-3 rounded-xl bg-slate-900 border border-slate-800 text-xs font-mono text-cyan-300 overflow-x-auto">
