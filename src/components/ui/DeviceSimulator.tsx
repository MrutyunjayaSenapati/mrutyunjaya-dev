...
export default function DeviceSimulator() {
  ...
  return (
    <div className="w-full max-w-md mx-auto rounded-3xl border border-border glass-panel p-4 shadow-2xl relative overflow-hidden">
      ...
      <div className="absolute -top-24 -right-24 w-48 h-48 bg-primary/20 rounded-full blur-2xl pointer-events-none" />
      <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-accent/20 rounded-full blur-2xl pointer-events-none" />
      ...
      <AnimatePresence mode="wait">
        {activeTab === "mobile" ? (
          ...
          >
            ...
            <div className="w-[260px] h-[480px] bg-terminal rounded-[36px] border-[6px] border-terminal-border p-3 shadow-2xl relative flex flex-col justify-between overflow-hidden">
              {/* Notch / Dynamic Island */}
              <div className="absolute top-2 left-1/2 -translate-x-1/2 w-20 h-4 bg-terminal-raised rounded-full z-20 flex items-center justify-center">
                <div className="w-2.5 h-2.5 rounded-full bg-terminal ml-auto mr-2" />
              </div>

              {/* Status Bar */}
              <div className="flex justify-between items-center text-[10px] text-terminal-muted pt-1.5 px-2 z-10 font-mono">
                <span>9:41</span>
                <div className="flex items-center gap-1">
                  <span>5G</span>
                  <span>100%</span>
              ...
              <div className="flex-1 my-2 rounded-2xl bg-surface-elevated border border-border/50 p-3 flex flex-col justify-between overflow-hidden relative">
                {selectedApp === "plant" ? (
                  <div className="space-y-2.5 text-left">
                    ...
                    <div className="rounded-xl bg-terminal-raised/80 border border-emerald-500/30 p-2.5 space-y-1.5">
                    ...
                    <div className="rounded-xl bg-terminal-raised/60 border border-border p-2 space-y-1">
                      <div className="text-[10px] font-medium text-primary-light">Gemini LLM Care Workflow</div>
                  ...
                  <div className="space-y-2.5 text-left">
                    ...
                    <div className="grid grid-cols-2 gap-1.5 text-[9px]">
                      <div className="p-1.5 rounded-lg bg-terminal-raised border border-amber-500/30">
                        <div className="text-amber-400 font-medium">📱 Customer App</div>
                        <div className="text-text-muted">Live Tracking</div>
                      </div>
                      <div className="p-1.5 rounded-lg bg-terminal-raised border border-primary/30">
                        <div className="text-primary-light font-medium">🚚 Partner App</div>
                        <div className="text-text-muted">Driver Route</div>
                      </div>
                      <div className="p-1.5 rounded-lg bg-terminal-raised border border-accent/30">
                        <div className="text-accent font-medium">🛠️ Admin Web</div>
                        <div className="text-text-muted">Platform Analytics</div>
                      </div>
                      <div className="p-1.5 rounded-lg bg-terminal-raised border border-primary/30">
                        <div className="text-primary-light font-medium">🏪 Restaurant Web</div>
                        <div className="text-text-muted">Menu Control</div>
                      </div>
                    </div>

                    <div className="p-2 rounded-xl bg-terminal-raised border border-border text-[9px] text-text-muted">
              ...
              <div className="w-24 h-1 bg-terminal-muted/50 rounded-full mx-auto" />
            </div>
          </motion.div>
        ) : (
          <motion.div
            ...
            exit={{ opacity: 0, scale: 0.96 }}
            transition={{ duration: 0.3 }}
            className="w-full bg-terminal rounded-2xl border border-border p-4 font-mono text-xs text-left space-y-3"
          >
            <div className="flex items-center justify-between border-b border-terminal-border pb-2 text-[11px] text-terminal-muted">
              <div className="flex items-center gap-1.5">
                ...
                <span className="ml-2 font-semibold text-terminal-text">AWS Infrastructure Health</span>
              </div>
              <span className="text-accent">us-east-1</span>
            </div>

            <div className="space-y-1.5 text-[11px]">
              <div className="text-emerald-400">➜ postgresql_pool: CONNECTED (Pool Size: 20)</div>
              <div className="text-primary-light">➜ fastapi_service: RUNNING (Uvicorn / Python 3.12)</div>
              <div className="text-accent">➜ express_gateway: ONLINE (Node.js v22)</div>
              <div className="text-amber-400">➜ docker_containers: 4 Active Services</div>
            </div>

            <div className="p-2.5 rounded-xl bg-terminal-raised/90 border border-terminal-border space-y-1 text-[10px]">
              ...
              <div className="flex justify-between text-terminal-text">
                ...
                <span className="text-accent font-bold">142 MB / 512 MB</span>
              </div>
              <div className="flex justify-between text-terminal-text">
                <span>Type Safety Check</span>
                <span className="text-primary-light font-bold">100% Passed</span>
              </div>
            </div>

            <div className="text-[10px] text-terminal-muted text-center pt-1 border-t border-terminal-border">
